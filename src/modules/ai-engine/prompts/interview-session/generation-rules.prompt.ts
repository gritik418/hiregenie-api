...
- The First Question/Prompt: You MUST ask the candidate for a brief introduction to start the interview (e.g., asking them to introduce themselves, walk through their background briefly, and highlight their relevant experience for the target role). Ask ONLY this single question/prompt. Do not include any other question.
