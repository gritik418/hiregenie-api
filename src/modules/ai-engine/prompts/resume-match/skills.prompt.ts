...
1. "skills.matched":
   ...
   - E.g., if the job description mentions a specific required skill or technology, and it is NOT explicitly present in the candidate's resume text, you MUST NOT list it in "skills.matched".
...
3. "skills.partial":
   - List skills where the candidate has only brief exposure, theoretical knowledge, or closely related/alternative skills (e.g., has SkillA but SkillB is required) but lacks professional production experience.
