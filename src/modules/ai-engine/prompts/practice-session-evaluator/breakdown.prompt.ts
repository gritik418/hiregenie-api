...
If the candidate has answered "I don't know", "idk", or left answers blank for all questions:
...
- Do not award default pass scores (like 50 or 60) for communication or confidence if they did not answer the questions. Stating "I don't know" does not demonstrate professional technical communication or confidence.
`;
